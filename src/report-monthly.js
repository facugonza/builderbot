...
function sendEmail() {
  ...
  */
  ...
  FROM (
      ...
      FROM history
      WHERE DATE(creationDate) BETWEEN '2024-11-01' AND '2024-11-30'
      ...
      FROM messages
      WHERE DATE(fecha_hora) BETWEEN '2024-11-01' AND '2024-11-30'
  ...
  connection.query(sql, (error, results) => {
    ...
    connection.query(keywordSql, async (error, keywordResults) => {
      ...
      const mailOptions = {
        ...
        subject:  'Resumen DATABOT mensual 11-2024', //`Cantidad de Personas Atendidas hoy: (${todayDate})`,
        html: emailContent
        /*
        attachments: [{
